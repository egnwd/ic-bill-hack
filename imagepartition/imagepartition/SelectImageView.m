...
- (void)updateBoundingRect {
    ...
    // Now we have the user selected bound, perform image processing!
    ...
    // 4. Find longest chain where there are no more than 5 consective empty rows
    ...
    selection = CGRectMake(selection.origin.x,
                           selection.origin.y + start,
